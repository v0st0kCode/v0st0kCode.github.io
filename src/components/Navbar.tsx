  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      <nav className="container-custom flex justify-center items-center">
        <Link 
          to="/" 
          className={`font-outfit font-normal text-xl tracking-tight hover:opacity-80 transition-all duration-1000 ease-out text-shadow text-center mt-5 md:mt-24 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
