      ...
      <section className="relative overflow-hidden h-screen">
        ...
        <div className="absolute inset-0 flex items-center justify-center pb-16">
          <div className={`container-custom text-center max-w-4xl transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">Hey, I’m Ivan Thomas, a digital product designer with more than two decades of experience crafting user‑friendly and result‑oriented digital solutions. This portfolio’s still being polished, but you can peek at my LinkedIn or drop me a line—happy to chat!</p>
